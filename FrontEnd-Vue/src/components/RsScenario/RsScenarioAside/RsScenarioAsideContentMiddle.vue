...
<script>
export default {
  name: 'rs-scenario-aside-content-middle',
  data () {
    return {
      testItems: [
        {
...
<style scoped>
.rs-scenario-aside-content-middle{
  position: absolute;
  padding-left: 20px;
  top: 50%;
  height: 10%;
